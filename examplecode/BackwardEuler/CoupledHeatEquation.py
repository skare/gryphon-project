...
from dolfin import RectangleMesh, FiniteElement, FunctionSpace, TestFunctions, TrialFunctions, Point, inner, grad, \
...
domainSource = Expression("0.1*t*exp(-((x[0]-0.7)*(x[0]-0.7) + (x[1]-0.5)*(x[1]-0.5))/0.01)", t=0, degree=1)
